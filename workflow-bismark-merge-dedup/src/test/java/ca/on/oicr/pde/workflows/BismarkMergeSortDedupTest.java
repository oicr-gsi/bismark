 ...
 * @author prath
 */
public class BismarkMergeSortDedupTest {
    
    public BismarkMergeSortDedupTest() {
    }
    ...
    public void validateRegressionTestDefinition() throws IllegalAccessException, InstantiationException, IOException, Exception {
        ...
        for (TestDefinition.Test t : td.getTests()) {
            DryRun d = new DryRun(System.getProperty("bundleDirectory"), t.getParameters(), BismarkMergeSortDedup.class);
